...
# Define some course relevant variables
unset QMGROUPS
declare -A QMGROUPS
...
# Download the checkbox tables
# This actually downloads the HTML webpage that shows the table, the tab is called Submission list
...
# Turn the HTML webpage into a CSV file using xmllint and R
for qmgroup in "${!QMGROUPS[@]}"
do
